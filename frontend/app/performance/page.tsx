    ...
    return (
        ...
        >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <PerformanceMetric label="Classification Accuracy" value={50.0} suffix="%" icon={Target} />
                <PerformanceMetric label="Model Precision" value={50.0} suffix="%" icon={Zap} />
                <PerformanceMetric label="Recall Sensitivity" value={100} suffix="%" icon={RefreshCcw} />
                <PerformanceMetric label="F1 Performance" value={66.6} suffix="%" icon={ShieldCheck} />
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
                ...
                <div className="lg:col-span-8 space-y-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-zinc-200 border border-zinc-200 rounded-3xl overflow-hidden shadow-sm">
                        <MatrixCell label="True Positive (Sensitivity)" value="34,978" icon={CheckCircle2} status="success" desc="Correct high-risk stratifications" />
                        <MatrixCell label="False Positive (Type I)" value="35,020" icon={XCircle} status="error" desc="Healthy cases inaccurately flagged" />
                        <MatrixCell label="False Negative (Type II)" value="1" icon={XCircle} status="error" desc="High-risk cases unidentified" />
                        <MatrixCell label="True Negative (Specificity)" value="1" icon={CheckCircle2} status="success" desc="Healthy cases correctly verified" />
                    </div>
                </div>
                ...
                <div className="lg:col-span-4 space-y-12">
                    ...
                    <div className="bg-rose-50/50 border border-rose-300 p-10 rounded-3xl text-rose-950 space-y-8 shadow-sm">
                        <div className="space-y-2">
                            <p className="text-[10px] uppercase text-rose-400">Live Calibration</p>
                            <h3 className="text-3xl font-medium">Active Modeling</h3>
                        </div>
                        <div className="flex items-end justify-between">
                            <div className="space-y-1">
                                <p className="text-5xl font-medium">70,000+</p>
                                <p className="text-[10px] text-rose-400 uppercase">Training Corpus Size</p>
                            </div>
    ...
    return (
        <div className="bg-white p-10 space-y-6 border-zinc-200">
            ...
            <div>
                ...
                <p className="text-[10px] text-zinc-400 uppercase mt-2">{label}</p>
            </div>
